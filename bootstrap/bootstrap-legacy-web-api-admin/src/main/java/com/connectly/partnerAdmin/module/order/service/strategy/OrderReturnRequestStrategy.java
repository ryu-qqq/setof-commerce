...
@Transactional
@Service
public class OrderReturnRequestStrategy extends AbstractOrderUpdateStrategy<ClaimOrder> {

    public OrderReturnRequestStrategy(OrderStatusProcessor orderStatusProcessor, OrderFetchService orderFetchService) {
