...
import com.connectly.partnerAdmin.module.crawl.dto.request.CrawlProductGroupUpdateRequestDto;
...
@Slf4j
@Component
public class CrawlProductUpdateHandler {
    ...
    public CrawlProductUpdateHandler(CrawlProductFinder crawlProductFinder, CrawlProductRegister crawlProductRegister,
    ...
    public long handle(CrawlProductGroupUpdateRequestDto requestDto) {
        int cnt = 0;
        for(CrawlProductGroupInsertRequestDto event : requestDto.getEvents()){
            long handle = handleCrawlProductInsertRequestDto(event);
            if(handle > 0){
                cnt++;
            }
        }
    ...
    private long handleCrawlProductInsertRequestDto(CrawlProductGroupInsertRequestDto requestDto) {
