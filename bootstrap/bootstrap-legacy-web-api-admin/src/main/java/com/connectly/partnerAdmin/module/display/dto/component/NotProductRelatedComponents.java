...
public class NotProductRelatedComponents {
    ...
    @Builder.Default
    private Set<TitleComponentQueryDto> titleComponents = new HashSet<>();
    @Builder.Default
    private Set<TextComponentQueryDto> textComponents = new HashSet<>();
    @Builder.Default
    private Set<ImageComponentQueryDto> imageComponents = new HashSet<>();
    @Builder.Default
    private Set<BlankComponentQueryDto> blankComponents = new HashSet<>();

    @QueryProjection
    public NotProductRelatedComponents(long contentId, Set<TitleComponentQueryDto> titleComponents, Set<TextComponentQueryDto> textComponents, Set<ImageComponentQueryDto> imageComponents, Set<BlankComponentQueryDto> blankComponents) {
