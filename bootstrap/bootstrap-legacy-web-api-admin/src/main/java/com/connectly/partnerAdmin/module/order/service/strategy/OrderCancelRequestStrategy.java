...
@Transactional
@Service
public class OrderCancelRequestStrategy extends AbstractOrderUpdateStrategy<ClaimOrder> {



    public OrderCancelRequestStrategy(OrderStatusProcessor orderStatusProcessor, OrderFetchService orderFetchService) {
