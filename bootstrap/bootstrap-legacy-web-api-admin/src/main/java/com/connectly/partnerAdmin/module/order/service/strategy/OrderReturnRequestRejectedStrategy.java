...
@Transactional
@Service
public class OrderReturnRequestRejectedStrategy extends AbstractOrderUpdateStrategy<ClaimOrder> {


    public OrderReturnRequestRejectedStrategy(OrderStatusProcessor orderStatusProcessor, OrderFetchService orderFetchService) {
        super(orderStatusProcessor, orderFetchService);
    }

    @Override
    public OrderStatus getOrderStatus() {
        return OrderStatus.RETURN_REQUEST_REJECTED;
    }


    @Override
    protected void additionalUpdateLogic(Order order, ClaimOrder updateOrder) {}
