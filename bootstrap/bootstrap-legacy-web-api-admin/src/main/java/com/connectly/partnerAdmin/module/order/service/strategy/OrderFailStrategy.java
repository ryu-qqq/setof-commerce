...
@Transactional
@Service
public class OrderFailStrategy extends AbstractRefundOrderStrategy<NormalOrder> {

    public OrderFailStrategy(OrderStatusProcessor orderStatusProcessor, OrderFetchService orderFetchService, OrderRefundService orderRefundService, InventoryService inventoryService) {
