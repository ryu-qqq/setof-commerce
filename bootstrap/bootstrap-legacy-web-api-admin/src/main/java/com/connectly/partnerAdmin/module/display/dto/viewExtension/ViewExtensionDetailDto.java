package com.connectly.partnerAdmin.module.display.dto.viewExtension;
...
public class ViewExtensionDetailDto {
    ...
    public ViewExtensionDetailDto(long componentId, ViewExtensionType viewExtensionType, String linkUrl, String buttonName, int productCountPerClick, int maxClickCount, ViewExtensionType afterMaxActionType, String afterMaxActionLinkUrl) {
