...
public enum SearchKeyword implements EnumType {
    ...
    PRODUCT_GROUP_ID("id"),
    ORDER_SNAPSHOT_PRODUCT_GROUP_ID("id"),
    ...
    MEMBER_PHONE_NUMBER("phoneNubmer"),
    ...
    public boolean isProductGroupName(){return this.equals(SearchKeyword.PRODUCT_GROUP_NAME);}
