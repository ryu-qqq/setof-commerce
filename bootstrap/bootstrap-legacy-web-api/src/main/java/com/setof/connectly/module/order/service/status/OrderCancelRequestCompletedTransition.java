...
@Component
public class OrderCancelRequestCompletedTransition implements OrderStatusTransition {

    @Override
    public OrderStatus getHandledStatus() {
        return OrderStatus.CANCEL_REQUEST_COMPLETED;
    }
    ...
    public boolean canTransition(OrderStatus toStatus) {
        return toStatus.isOrderCompleted() || toStatus.isCancelRequest();
    }
}
