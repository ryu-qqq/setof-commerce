package com.setof.connectly.module.order.entity.snapshot.image;
...
@Entity
public class OrderSnapShotProductGroupImage extends BaseEntity implements OrderSnapShot {
    ...
    @Embedded private SnapShotProductGroupImage snapShotProductGroupImage;
