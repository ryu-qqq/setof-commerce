...
@Transactional
@Service
public class OrderCancelRecantService extends AbstractOrderUpdateService<NormalOrder> {

    public OrderCancelRecantService(
    ...
    public List<UpdateOrderResponse> updateOrder(NormalOrder normalOrder) {
        ...
        normalOrder.setOrderStatus(OrderStatus.ORDER_COMPLETED);
