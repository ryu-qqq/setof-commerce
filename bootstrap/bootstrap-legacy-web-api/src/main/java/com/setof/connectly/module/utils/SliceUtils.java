...
public class SliceUtils {
    ...
    public static <T> Slice<T> toSlice(List<T> contents, Pageable pageable) {
        ...
        return new SliceImpl<>(
                hasNext ? subListLastContent(contents, pageable) : contents, pageable, hasNext);
    }
    ...
    private static <T> boolean isContentSizeGreaterThanPageSize(
            List<T> content, Pageable pageable) {
