...
public class MileageException extends ApplicationException {
    protected MileageException(String errorCode, HttpStatus httpStatus, String message) {
        super(errorCode, httpStatus, message);
    }

    protected MileageException(
