package com.setof.connectly.module.order.entity.snapshot.delivery;
...
@Entity
public class OrderSnapShotProductDelivery extends BaseEntity implements OrderSnapShot {
    ...
    @Embedded private SnapShotProductDelivery snapShotProductDelivery;
