...
public class ForbiddenOrderStatusException extends OrderException {
    ...
    private static String buildMessage(
        ...
        return String.format(
                ...
                BASE_MESSAGE, orderId, pastOrderStatus, toOrderStatus);
    }
}
