...
import com.ryuqq.setof.storage.mysql.member.repository.MemberQueryDslRepository;
...
public class MemberQueryAdapter implements MemberQueryPort {
    ...
    public Optional<Member> findById(MemberId id) {
        return queryDslRepository.findById(id.getValue()).map(memberJpaEntityMapper::toDomain);
    }
    ...
    public Optional<Member> findBySocialId(SocialId socialId) {
        return queryDslRepository
                .findBySocialId(socialId.getValue())
                .map(memberJpaEntityMapper::toDomain);
    }
    ...
    public boolean existsByPhoneNumber(PhoneNumber phoneNumber) {
        return queryDslRepository.existsByPhoneNumber(phoneNumber.getValue());
    }
}
