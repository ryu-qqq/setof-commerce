 ...
 *
 * <ul>
 *   <li>createdAt - 생성 일시 (BaseAuditEntity 상속, UTC 기준 Instant)
 *   <li>updatedAt - 수정 일시 (BaseAuditEntity 상속, UTC 기준 Instant)
 *   <li>deletedAt - 삭제 일시 (null이면 활성, UTC 기준 Instant)
 * </ul>
 *
...
public abstract class SoftDeletableEntity extends BaseAuditEntity {
     ...
     * @param deletedAt 삭제 일시 (nullable, UTC 기준 Instant)
     */
     ...
     * 삭제 일시 조회
     *
     * @return 삭제 일시 (null이면 활성 상태, UTC 기준 Instant)
     */
