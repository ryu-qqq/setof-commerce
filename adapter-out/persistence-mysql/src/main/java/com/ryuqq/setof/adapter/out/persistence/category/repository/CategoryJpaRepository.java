 ...
 *
 * <p>Spring Data JPA Repository로서 Category Entity의 기본 CRUD를 담당합니다.
 *
 ...
 *
 * <ul>
 *   <li>모든 Query 작업은 CategoryQueryDslRepository 사용
 * </ul>
 *
 * <p><strong>참고:</strong> 이 프로젝트에서 Category는 읽기 전용이므로 Command 메서드는 배치 서비스에서만 사용됩니다.
 *
