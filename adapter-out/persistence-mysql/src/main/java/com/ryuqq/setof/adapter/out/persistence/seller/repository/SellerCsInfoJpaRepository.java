...
/**
 * SellerCsInfoJpaRepository - Seller CS Info JPA Repository
 *
 * <p>Spring Data JPA Repository로서 SellerCsInfo Entity의 기본 CRUD를 담당합니다.
 *
 ...
 * @since 1.0.0
 */
public interface SellerCsInfoJpaRepository extends JpaRepository<SellerCsInfoJpaEntity, Long> {
    // Query Method 추가 금지
    // @Query 추가 금지
}
