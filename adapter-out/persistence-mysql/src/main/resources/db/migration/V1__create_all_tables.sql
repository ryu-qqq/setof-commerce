-- ============================================================
-- V1: Create all tables for setof-commerce
-- Based on JPA entities in adapter-out/persistence-mysql
-- ============================================================
...
CREATE TABLE sellers (
    ...
    is_active            TINYINT(1)      NOT NULL DEFAULT 1,
    auth_tenant_id       VARCHAR(100)    NULL,
    auth_organization_id VARCHAR(100)    NULL,
    created_at           DATETIME(6)     NOT NULL,
    updated_at           DATETIME(6)     NOT NULL,
    deleted_at           DATETIME(6)     NULL,
    PRIMARY KEY (id),
...
CREATE TABLE seller_business_infos (
    ...
    business_zipcode        VARCHAR(10)     NULL,
    business_address        VARCHAR(200)    NULL,
    business_address_detail VARCHAR(200)    NULL,
    created_at              DATETIME(6)     NOT NULL,
    updated_at              DATETIME(6)     NOT NULL,
    deleted_at              DATETIME(6)     NULL,
    PRIMARY KEY (id),
