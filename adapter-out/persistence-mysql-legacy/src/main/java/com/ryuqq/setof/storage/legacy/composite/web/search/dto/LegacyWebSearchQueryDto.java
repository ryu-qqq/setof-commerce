package com.ryuqq.setof.storage.legacy.composite.web.search.dto;

import java.time.LocalDateTime;

/**
 * LegacyWebSearchQueryDto - 레거시 Web 검색 결과 조회 Projection DTO.
 *
 * <p>Projections.constructor()로 매핑 (Q클래스 생성 불필요).
 *
 * <p>product_group, product_group_image(MAIN), brand, product_rating_stats, product_score 조인 결과를
 * 담습니다.
 *
 ...
 * @since 1.1.0
 */
public record LegacyWebSearchQueryDto(
        long productGroupId,
        long sellerId,
