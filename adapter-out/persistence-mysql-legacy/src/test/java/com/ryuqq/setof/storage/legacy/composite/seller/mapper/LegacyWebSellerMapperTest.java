package com.ryuqq.setof.storage.legacy.composite.seller.mapper;

import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_ADDRESS_LINE1;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_ADDRESS_LINE2;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_COMPANY_NAME;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_CREATED_AT;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_CS_EMAIL;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_CS_NUMBER;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_CS_PHONE;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_LOGO_URL;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_REGISTRATION_NUMBER;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_REPRESENTATIVE;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_SALE_REPORT_NUMBER;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_SELLER_DESCRIPTION;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_SELLER_ID;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_SELLER_NAME;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_UPDATED_AT;
import static com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures.DEFAULT_ZIP_CODE;
import static org.assertj.core.api.Assertions.assertThat;

import com.ryuqq.setof.application.seller.dto.composite.SellerCompositeResult;
import com.ryuqq.setof.storage.legacy.composite.seller.LegacyWebSellerQueryDtoFixtures;
