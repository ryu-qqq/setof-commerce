-- ============================================================
-- Member Integration Test Data
-- ============================================================
-- 회원 통합 테스트용 샘플 데이터
-- H2 MySQL Compatibility Mode 사용
-- ============================================================

-- 기존 데이터 삭제 (테스트 격리 - 자식 테이블부터 삭제)
...
-- Note: deleted_at is NULL to allow status validation (WITHDRAWN status triggers 403, not Soft Delete)
INSERT INTO members (
    id, phone_number, email, password_hash, name,
    date_of_birth, gender, provider, social_id, status,
    privacy_consent, service_terms_consent, ad_consent,
