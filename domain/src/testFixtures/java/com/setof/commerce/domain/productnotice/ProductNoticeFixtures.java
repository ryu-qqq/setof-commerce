...
public final class ProductNoticeFixtures {
    ...
    public static ProductNoticeEntry defaultNoticeEntry() {
        return ProductNoticeEntry.forNew(defaultFieldValue(), 1);
    }

    /** 커스텀 필드명/필드값을 가진 신규 고시 항목을 생성한다. */
    public static ProductNoticeEntry noticeEntry(String fieldName, String fieldValue) {
        return ProductNoticeEntry.forNew(NoticeFieldValue.of(fieldName, fieldValue), 1);
    }

    /** 일반적인 상품고시 항목 목록(신규)을 반환한다. */
    public static List<ProductNoticeEntry> defaultEntries() {
        return List.of(
                ProductNoticeEntry.forNew(NoticeFieldValue.of("소재", "면 100%"), 1),
                ProductNoticeEntry.forNew(NoticeFieldValue.of("세탁방법", "손세탁"), 2),
                ProductNoticeEntry.forNew(NoticeFieldValue.of("제조국", "대한민국"), 3),
                ProductNoticeEntry.forNew(NoticeFieldValue.of("제조자", "테스트제조사"), 4));
    }
    ...
    public static List<ProductNoticeEntry> reconstitutedDefaultEntries() {
        return List.of(
                ProductNoticeEntry.reconstitute(
                        ProductNoticeEntryId.of(10L), NoticeFieldValue.of("소재", "면 100%"), 1),
                ProductNoticeEntry.reconstitute(
                        ProductNoticeEntryId.of(11L), NoticeFieldValue.of("세탁방법", "손세탁"), 2),
                ProductNoticeEntry.reconstitute(
                        ProductNoticeEntryId.of(12L), NoticeFieldValue.of("제조국", "대한민국"), 3),
                ProductNoticeEntry.reconstitute(
                        ProductNoticeEntryId.of(13L), NoticeFieldValue.of("제조자", "테스트제조사"), 4));
    }
