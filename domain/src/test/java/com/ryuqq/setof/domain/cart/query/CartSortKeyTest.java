...
@Tag("unit")
@DisplayName("CartSortKey 단위 테스트")
class CartSortKeyTest {
    ...
    class SortKeyInterfaceTest {
        ...
        @Test
        @DisplayName("CartSortKey는 SortKey 인터페이스를 구현한다")
        void implementsSortKey() {
            // then
            assertThat(CartSortKey.CREATED_AT).isInstanceOf(SortKey.class);
        }
    }
    ...
    class FieldNameTest {
        ...
        void createdAtFieldName() {
            // then
            assertThat(CartSortKey.CREATED_AT.fieldName()).isEqualTo("createdAt");
        }
    }
    ...
    class DefaultKeyTest {
        ...
        void defaultKeyIsCreatedAt() {
            // then
            assertThat(CartSortKey.defaultKey()).isEqualTo(CartSortKey.CREATED_AT);
        }
    }
    ...
    class EnumValuesTest {
        ...
        void allValuesExist() {
            // then
            assertThat(CartSortKey.values()).containsExactly(CartSortKey.CREATED_AT);
        }
    }
}
