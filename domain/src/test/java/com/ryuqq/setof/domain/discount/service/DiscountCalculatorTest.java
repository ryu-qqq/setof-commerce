...
@Tag("unit")
@DisplayName("DiscountCalculator 도메인 서비스 테스트")
class DiscountCalculatorTest {
    ...
    class NoPoliciesTest {
        ...
        void nullPoliciesReturnsNoDiscount() {
            DiscountedPrice result = calculator.calculate(Money.of(100000), Money.of(100000), null);
        ...
        void emptyPoliciesReturnsNoDiscount() {
            DiscountedPrice result =
                    calculator.calculate(
                            Money.of(100000), Money.of(100000), Collections.emptyList());
    ...
    class SinglePolicyTest {
        ...
        void applySingleRatePolicy() {
            DiscountPolicy policy =
                    DiscountFixtures.activePolicyWithPriority(
                            1L, 50, StackingGroup.PLATFORM_INSTANT);

            DiscountedPrice result =
                    calculator.calculate(Money.of(100000), Money.of(100000), List.of(policy));
    ...
    class SameGroupExclusiveTest {
        ...
        void onlyHighestPriorityInSameGroup() {
    ...
    class LimitsTest {
        ...
        void discountDoesNotExceedCurrentPrice() {
            DiscountPolicy bigDiscount =
                    DiscountFixtures.fixedAmountPolicy(1L, 200000, StackingGroup.SELLER_INSTANT);

            DiscountedPrice result =
                    calculator.calculate(Money.of(100000), Money.of(100000), List.of(bigDiscount));
        ...
        void sequentialApplicationBasedOnRunningPrice() {
    ...
    class ShareRatioTest {
        ...
        void singlePolicyShareRatioIsOne() {
            DiscountPolicy policy =
                    DiscountFixtures.fixedAmountPolicy(1L, 5000, StackingGroup.SELLER_INSTANT);
        ...
        void multiPoliciesShareRatiosSumToOne() {
            DiscountPolicy sellerPolicy =
                    DiscountFixtures.fixedAmountPolicy(1L, 5000, StackingGroup.SELLER_INSTANT);
            DiscountPolicy platformPolicy =
    ...
    class DiscountRateCalculationTest {
        ...
        void calculateDiscountRateFromRegularPrice() {
            DiscountPolicy policy =
        ...
        void discountRateBasedOnRegularPrice() {
            DiscountPolicy policy =
                    DiscountFixtures.fixedAmountPolicy(1L, 5000, StackingGroup.PLATFORM_INSTANT);

            // regularPrice 100000, currentPrice 80000 → 5000 할인 → 할인율: 5000/100000 = 5%
            DiscountedPrice result =
                    calculator.calculate(Money.of(100000), Money.of(80000), List.of(policy));
