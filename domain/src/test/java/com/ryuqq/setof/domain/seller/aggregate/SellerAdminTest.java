...
class SellerAdminTest {
    ...
    class ForNewTest {
        ...
        void createNewAdminWithSellerId() {
            ...
            // when
            SellerAdmin admin =
                    SellerAdmin.forNew(sellerId, authUserId, loginId, name, phoneNumber, now);

            // then
            assertThat(admin.isNew()).isTrue();
        ...
        void createNewAdminWithoutSellerId() {
            ...
            // when
            SellerAdmin admin = SellerAdmin.forNew(authUserId, loginId, name, phoneNumber, now);
    ...
    class ForApplicationTest {
        ...
        void createApplicationAdmin() {
            // given
            SellerId sellerId = CommonVoFixtures.defaultSellerId();
            String loginId = "pending@test.com";
            String name = "김대기";
            ...
            // when
            SellerAdmin admin =
                    SellerAdmin.forApplication(sellerId, loginId, name, phoneNumber, now);
