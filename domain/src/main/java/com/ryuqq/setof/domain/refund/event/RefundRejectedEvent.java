 ...
 */
public record RefundRejectedEvent(RefundId refundId, OrderId orderId, Instant occurredAt)
        implements DomainEvent {

    public static RefundRejectedEvent of(RefundId refundId, OrderId orderId, Instant now) {
