...
public record ContentId(Long value) {
    ...
    public ContentId {
        if (value != null && value <= 0) {
            throw new IllegalArgumentException("ContentId는 양수여야 합니다: " + value);
        }
    }
     ...
     */
    public static ContentId forNew() {
    ...
    public static ContentId of(Long value) {
        if (value == null) {
            throw new IllegalArgumentException("기존 ContentId는 null일 수 없습니다");
        }
