 ...
 * 장바구니 커서 기반 검색 조건.
 *
 * <p>memberId(Long auto-increment PK) + userId(레거시) 모두 포함합니다.
 *
 * @param memberId 회원 ID (Long auto-increment PK)
...
public record CartSearchCriteria(
        Long memberId, Long userId, CursorQueryContext<CartSortKey, Long> queryContext) {
