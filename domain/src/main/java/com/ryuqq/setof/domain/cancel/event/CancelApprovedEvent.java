 ...
 */
public record CancelApprovedEvent(CancelId cancelId, OrderId orderId, Instant occurredAt)
        implements DomainEvent {

    public static CancelApprovedEvent of(CancelId cancelId, OrderId orderId, Instant occurredAt) {
