 ...
 */
public record RefundCollectedEvent(RefundId refundId, OrderId orderId, Instant occurredAt)
        implements DomainEvent {

    public static RefundCollectedEvent of(RefundId refundId, OrderId orderId, Instant now) {
