...
public enum MemberErrorCode implements ErrorCode {
    ...
    // 환불 계좌 관련 (MBR-100 ~ MBR-149)
    REFUND_ACCOUNT_NOT_FOUND("MBR-101", 404, "환불 계좌를 찾을 수 없습니다"),
    ACCOUNT_VERIFICATION_FAILED("MBR-100", 400, "계좌 실명 검증에 실패했습니다"),

    // 배송지 관련 (MBR-150 ~ MBR-199)
    SHIPPING_ADDRESS_NOT_FOUND("MBR-150", 404, "배송지를 찾을 수 없습니다"),
    CANNOT_UNMARK_DEFAULT_SHIPPING_ADDRESS("MBR-151", 400, "기본 배송지 설정은 해제할 수 없습니다");
