 ...
 *   <li>forNew() + of() Static Factory 필수
 * </ul>
 *
 * <p>UUID v7 장점:
 *
...
public record MemberId(UUID value) {
    ...
    /**
     * Static Factory Method - 신규 생성용 (Application Layer에서 UUID 주입)
     *
     * <p>UUID v7은 Application Layer에서 UuidCreator.getTimeOrderedEpoch()로 생성합니다.
     *
     * @param value Application Layer에서 생성한 UUID v7
     * @return 새로운 MemberId
     * @throws InvalidMemberIdException value가 null인 경우
     */
    public static MemberId forNew(UUID value) {
