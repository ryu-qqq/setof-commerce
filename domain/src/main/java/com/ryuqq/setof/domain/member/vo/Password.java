 ...
 *   <li>BCrypt 해시값 저장 (해시화는 Application Layer 책임)
 *   <li>NotBlank 검증
 *   <li>Private 생성자 + Static Factory - 외부 직접 생성 금지
 * </ul>
 *
 * <p>주의: 이 VO는 이미 해시된 비밀번호를 저장합니다. 원본 비밀번호의 해시화는 Application Layer에서 수행됩니다.
 *
 * <p>비밀번호 정책 (회원가입 시 Application Layer에서 검증):
 *
 * <ul>
 *   <li>8자 이상
 *   <li>영문 대문자 1개 이상
...
public record Password(String value) {
     ...
     *
     * <p>Application Layer에서 원본 비밀번호의 정책 준수 여부를 검증할 때 사용합니다. 해시화 전 원본 비밀번호에 대해 호출해야 합니다.
     *
