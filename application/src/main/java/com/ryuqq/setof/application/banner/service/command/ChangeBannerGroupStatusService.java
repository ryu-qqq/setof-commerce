...
/**
 * ChangeBannerGroupStatusService - 배너 그룹 노출 상태 변경 Service.
 *
 ...
 *   <li>도메인 changeDisplayStatus() 호출로 노출 상태 변경
 *   <li>Manager를 통해 저장
 * </ol>
 *
 * @author ryu-qqq
 ...
 */
@Service
public class ChangeBannerGroupStatusService implements ChangeBannerGroupStatusUseCase {
    ...
    public ChangeBannerGroupStatusService(
    ...
    @Override
    public void execute(ChangeBannerGroupStatusCommand command) {
        StatusChangeContext<BannerGroupId> context =
                bannerGroupCommandFactory.createStatusChangeContext(command);
