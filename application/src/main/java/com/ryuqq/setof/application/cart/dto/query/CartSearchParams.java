 ...
 *
 * @param memberId 회원 ID (Long PK, 새 DB 호환)
 ...
 * @since 1.1.0
 */
public record CartSearchParams(Long memberId, Long userId, Long lastCartId, Integer size) {
    ...
    public static CartSearchParams of(Long memberId, Long userId, Long lastCartId, Integer size) {
        return new CartSearchParams(memberId, userId, lastCartId, size);
    }

    public static CartSearchParams forCount(Long memberId, Long userId) {
