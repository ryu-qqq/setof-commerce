...
public class MemberUpdater {
    ...
    public MemberUpdater(PasswordEncoderPort passwordEncoderPort, Clock clock) {
    ...
    public void changePassword(Member member, String newRawPassword) {
        ...
        member.changePassword(newPassword, clock);
    }
    ...
    public void withdraw(Member member, String reason) {
        ...
        member.withdraw(withdrawalReason, clock);
    }
