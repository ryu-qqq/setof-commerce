 ...
 * @since 1.1.0
 */
public record DeleteCartItemsCommand(List<Long> cartIds, Long memberId, Long userId) {

    public static DeleteCartItemsCommand of(List<Long> cartIds, Long memberId, Long userId) {
        return new DeleteCartItemsCommand(cartIds, memberId, userId);
    }

    public static DeleteCartItemsCommand ofSingle(Long cartId, Long memberId, Long userId) {
