...
/**
 * RegisterNavigationMenuCommand - 네비게이션 메뉴 등록 Command.
 *
 * <p>네비게이션 메뉴 신규 등록 시 Adapter-In에서 Application Layer로 전달하는 Command DTO.
 *
 * @param title 메뉴명
 ...
 * @since 1.1.0
 */
public record RegisterNavigationMenuCommand(
        String title,
        String linkUrl,
        int displayOrder,
