...
/**
 * FetchProductGroupsByBrandService - 브랜드별 상품그룹 조회 Service.
 *
 ...
 */
@Service
public class FetchProductGroupsByBrandService implements FetchProductGroupsByBrandUseCase {

    private final ProductGroupReadFacade readFacade;
    private final ProductGroupAssembler assembler;

    public FetchProductGroupsByBrandService(
    ...
    @Override
    public ProductGroupSliceResult execute(Long brandId, int pageSize) {
        ProductGroupListBundle bundle = readFacade.getListBundleByBrand(brandId, pageSize);
