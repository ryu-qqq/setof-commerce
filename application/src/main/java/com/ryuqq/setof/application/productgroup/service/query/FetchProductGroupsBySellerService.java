...
/**
 * FetchProductGroupsBySellerService - 셀러별 상품그룹 조회 Service.
 *
 ...
 */
@Service
public class FetchProductGroupsBySellerService implements FetchProductGroupsBySellerUseCase {

    private final ProductGroupReadFacade readFacade;
    private final ProductGroupAssembler assembler;

    public FetchProductGroupsBySellerService(
