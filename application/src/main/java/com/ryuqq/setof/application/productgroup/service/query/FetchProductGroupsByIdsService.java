...
/**
 * FetchProductGroupsByIdsService - ID 목록 기반 상품그룹 조회 Service.
 *
 ...
 */
@Service
public class FetchProductGroupsByIdsService implements FetchProductGroupsByIdsUseCase {

    private final ProductGroupReadFacade readFacade;
    private final ProductGroupAssembler assembler;

    public FetchProductGroupsByIdsService(
