...
/**
 * GetProductGroupsByBrandService - 브랜드별 상품그룹 조회 Service.
 *
 ...
 */
@Service
public class GetProductGroupsByBrandService implements GetProductGroupsByBrandUseCase {

    private final ProductGroupReadFacade readFacade;
    private final ProductGroupAssembler assembler;

    public GetProductGroupsByBrandService(
