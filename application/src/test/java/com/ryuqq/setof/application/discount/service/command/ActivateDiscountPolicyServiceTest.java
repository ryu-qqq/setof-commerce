...
/**
 * ActivateDiscountPolicyService 테스트
 *
 * <p>할인 정책 활성화 서비스에 대한 단위 테스트
 */
@DisplayName("ActivateDiscountPolicyService")
@ExtendWith(MockitoExtension.class)
class ActivateDiscountPolicyServiceTest {
    ...
    private ActivateDiscountPolicyService activateDiscountPolicyService;

    @BeforeEach
    void setUp() {
        activateDiscountPolicyService =
                new ActivateDiscountPolicyService(
    ...
    class ExecuteTest {
        ...
        @Test
        @DisplayName("비활성화된 정책 활성화 성공")
        void shouldActivateInactivePolicySuccessfully() {
            // Given
            DiscountPolicy inactivePolicy = createInactivePolicy();
            ActivateDiscountPolicyCommand command =
                    new ActivateDiscountPolicyCommand(TEST_POLICY_ID, TEST_SELLER_ID);
            ...
            // When
            activateDiscountPolicyService.execute(command);
        ...
        @Test
        @DisplayName("이미 활성화된 정책에도 활성화 호출 가능")
        void shouldHandleAlreadyActivePolicy() {
            // Given
