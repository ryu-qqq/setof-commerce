...
public record CreateProductGroupV1ApiRequest(
        ...
        @Schema(
                ...
                @Length(max = 200, message = "상품 그룹명은 200자를 넘을 수 없습니다.")
        ...
        @Schema(description = "가격 정보", requiredMode = Schema.RequiredMode.REQUIRED)
                @Valid
                @NotNull(message = "가격 정보는 필수입니다.")
                CreatePriceV1ApiRequest price,
        ...
        @Schema(description = "상품 이미지 목록", requiredMode = Schema.RequiredMode.REQUIRED)
                @Valid
                @Size(min = 1, max = 10, message = "상품 이미지는 1개 이상 10개 이하여야 합니다.")
                @NotNull(message = "상품 이미지 목록은 필수입니다.")
                List<CreateProductImageV1ApiRequest> productImageList,
        ...
        @Schema(description = "상품 옵션 목록", requiredMode = Schema.RequiredMode.REQUIRED)
                @Size(min = 1, message = "적어도 하나 이상의 상품 옵션이 필요합니다.")
                @Valid
                @NotNull(message = "상품 옵션 목록은 필수입니다.")
                List<CreateOptionV1ApiRequest> productOptions) {}
