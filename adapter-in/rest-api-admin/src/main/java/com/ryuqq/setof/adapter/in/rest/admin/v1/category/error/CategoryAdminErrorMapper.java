package com.ryuqq.setof.adapter.in.rest.admin.v1.category.error;
...
/**
 * CategoryAdminErrorMapper - 카테고리 도메인 예외를 HTTP 응답으로 변환.
 *
 * <p>API-ERR-001: 도메인별 ErrorMapper를 구현하여 DomainException을 HTTP 응답으로 매핑.
 *
 * <p>rest-api-admin 모듈 전용.
 *
 * @author ryu-qqq
 * @since 1.0.0
 */
@Component
public class CategoryAdminErrorMapper implements ErrorMapper {
