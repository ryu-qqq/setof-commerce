...
public record OrderDateDashboardV1ApiResponse(
        ...
        @Schema(description = "주문 대시보드 랭킹 목록") List<OrderDashboardRankingV1ApiResponse> orderDashBoardRankings,
        @Schema(description = "외부몰 주문 통계 목록") List<OrderStatisticsV1ApiResponse> externalMallOrderStatistics) {
    ...
    public record OrderStatisticsV1ApiResponse(
            ...
            @Schema(description = "순수 주문 금액",
                    example = "8000000") java.math.BigDecimal pureOrderAmount) {
    }
