 ...
 * @since 2.0.0
 */
@Schema(description = "컴포넌트 생성 요청")
public record CreateComponentV2ApiRequest(
        @Schema(description = "컴포넌트 타입", example = "PRODUCT") @NotBlank(message = "컴포넌트 타입은 필수입니다")
        ...
        @Schema(description = "타입별 상세 정보") @NotNull @Valid ComponentDetailV2ApiRequest detail) {}
