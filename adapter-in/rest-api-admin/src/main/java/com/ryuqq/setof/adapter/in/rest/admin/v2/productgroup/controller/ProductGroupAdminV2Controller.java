...
/**
 * ProductGroup Admin V2 Controller
 *
 * <p>상품그룹 관리 API 엔드포인트
 *
 * <p>컨벤션 규칙:
...
@Validated
public class ProductGroupAdminV2Controller {
    ...
    public ProductGroupAdminV2Controller(
    ...
    public ResponseEntity<ApiResponse<ProductGroupListV2ApiResponse>> getProductGroups(
            ...
            @Parameter(description = "상품그룹명 (LIKE 검색)") @RequestParam(required = false) String name,
            @Parameter(description = "상태") @RequestParam(required = false) String status,
            @Parameter(description = "페이지 번호") @RequestParam(required = false, defaultValue = "0")
                    Integer page,
            @Parameter(description = "페이지 크기") @RequestParam(required = false, defaultValue = "20")
                    Integer size) {

        ProductGroupSearchV2ApiRequest request =
                new ProductGroupSearchV2ApiRequest(
        ...
        ProductGroupListV2ApiResponse apiResponse =
                ProductGroupListV2ApiResponse.of(
                        items, request.pageOrDefault(), request.sizeOrDefault(), totalCount);
