...
import com.ryuqq.setof.adapter.in.rest.admin.v2.productgroupdescription.ProductGroupDescriptionAdminEndpoints;
...
/**
 * ProductGroupDescriptionCommandController - 상품 그룹 상세 설명 등록/수정 API.
 *
 ...
 * @since 1.0.0
 */
@Tag(name = "상품 그룹 상세 설명 관리", description = "상품 그룹 상세 설명 등록/수정 API")
@RestController
@RequestMapping(ProductGroupDescriptionAdminEndpoints.BASE)
public class ProductGroupDescriptionCommandController {

    private final RegisterProductGroupDescriptionUseCase registerUseCase;
    private final UpdateProductGroupDescriptionUseCase updateUseCase;
    private final ProductGroupDescriptionCommandApiMapper mapper;

    /**
     * ProductGroupDescriptionCommandController 생성자.
     *
     * @param registerUseCase 상세 설명 등록 UseCase
     * @param updateUseCase 상세 설명 수정 UseCase
     * @param mapper Command API 매퍼
     */
    public ProductGroupDescriptionCommandController(
            RegisterProductGroupDescriptionUseCase registerUseCase,
            UpdateProductGroupDescriptionUseCase updateUseCase,
     ...
     * 상품 그룹 상세 설명 등록 API.
     *
     * <p>상품 그룹의 상세 설명을 등록합니다.
     *
     * @param productGroupId 상품 그룹 ID
     * @param request 등록 요청 DTO
     * @return 생성된 상세 설명 ID
     */
    @Operation(summary = "상세 설명 등록", description = "상품 그룹의 상세 설명을 등록합니다.")
    @ApiResponses({
    ...
    public ResponseEntity<ApiResponse<Long>> register(
            @Parameter(description = "상품 그룹 ID", required = true)
                    ...
                    Long productGroupId,
            @Valid @RequestBody RegisterProductGroupDescriptionApiRequest request) {
