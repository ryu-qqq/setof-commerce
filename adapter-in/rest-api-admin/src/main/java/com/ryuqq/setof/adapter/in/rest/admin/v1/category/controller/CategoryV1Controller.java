 ...
 *
 * <p>
 * 레거시 API 호환을 위한 V1 Category 엔드포인트
 *
...
public class CategoryV1Controller {
    ...
    public ResponseEntity<ApiResponse<List<TreeCategoryContextV1ApiResponse>>> fetchAllChildCategories(
    ...
    public ResponseEntity<ApiResponse<List<TreeCategoryContextV1ApiResponse>>> fetchAllParentCategories(
            @PathVariable("categoryId") long categoryId) {
    ...
    @GetMapping("/category")
    public ResponseEntity<ApiResponse<List<TreeCategoryContextV1ApiResponse>>> fetchAllCategoriesAsTree() {
    ...
    public ResponseEntity<ApiResponse<PageApiResponse<ProductCategoryContextV1ApiResponse>>> fetchCategories(
            @ModelAttribute CategoryFilterV1ApiRequest filter) {
    ...
    public ResponseEntity<ApiResponse<List<CategoryMappingInfoV1ApiResponse>>> convertExternalCategoryToInternalCategory(
            @PathVariable("siteId") long siteId,
            @Valid @RequestBody List<CategoryMappingInfoV1ApiRequest> categoryMappingInfos) {
