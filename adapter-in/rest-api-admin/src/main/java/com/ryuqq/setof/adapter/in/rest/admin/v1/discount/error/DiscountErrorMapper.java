...
/**
 * DiscountErrorMapper - 할인 도메인 예외를 HTTP 응답으로 변환.
 *
 ...
 */
@Component
public class DiscountErrorMapper implements ErrorMapper {

    private static final String ERROR_TYPE_PREFIX = "/errors/discount";

    @Override
    public boolean supports(DomainException ex) {
        return ex instanceof DiscountException;
    }
