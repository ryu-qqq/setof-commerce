package com.ryuqq.setof.adapter.in.rest.admin.v2.faq.dto.response;
...
public record FaqV2ApiResponse(
        ...
        @Schema(description = "상단 노출 여부", example = "false") boolean isTop,
        @Schema(description = "상단 순서", example = "0") int topOrder,
        @Schema(description = "표시 순서", example = "1") int displayOrder,
        @Schema(description = "상태", example = "PUBLISHED") String status,
        @Schema(description = "조회수", example = "100") int viewCount,
    ...
    /**
     * Application FaqResponse → API Response 변환
     *
