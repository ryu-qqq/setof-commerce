...
public record SellerInfoContextV1ApiRequest(
    ...
    public record SellerInfoInsertV1ApiRequest(
            ...
            @Schema(description = "셀러 로고 URL",
                    example = "https://example.com/logo.jpg") String sellerLogoUrl,
    ...
    public record SellerBusinessInfoV1ApiRequest(
            ...
            @Schema(description = "사업장 주소 1",
                    example = "서울시 강남구 테헤란로 123") String businessAddressLine1,
    ...
    public record SellerShippingInfoV1ApiRequest(
            @Schema(description = "반품 주소 1",
                    example = "서울시 강남구 테헤란로 123") String returnAddressLine1,
