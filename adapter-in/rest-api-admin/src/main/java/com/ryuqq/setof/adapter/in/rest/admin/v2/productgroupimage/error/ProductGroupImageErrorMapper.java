package com.ryuqq.setof.adapter.in.rest.admin.v2.productgroupimage.error;

import com.ryuqq.setof.adapter.in.rest.admin.common.mapper.ErrorMapper;
import com.ryuqq.setof.domain.common.exception.DomainException;
import com.ryuqq.setof.domain.productgroupimage.exception.ProductGroupImageException;
import java.net.URI;
...
/**
 * ProductGroupImageErrorMapper - 상품 그룹 이미지 도메인 예외를 HTTP 응답으로 변환.
 *
...
public class ProductGroupImageErrorMapper implements ErrorMapper {
    ...
    public boolean supports(DomainException ex) {
        return ex instanceof ProductGroupImageException;
    }
