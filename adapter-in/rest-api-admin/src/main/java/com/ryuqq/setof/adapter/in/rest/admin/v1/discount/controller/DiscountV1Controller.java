 ...
 *
 * <p>
 * 레거시 API 호환을 위한 V1 Discount 엔드포인트
 *
...
public class DiscountV1Controller {
    ...
    public ResponseEntity<ApiResponse<PageApiResponse<DiscountPolicyV1ApiResponse>>> getDiscountPolies(
            @ModelAttribute @Validated DiscountFilterV1ApiRequest filter) {
    ...
    public ResponseEntity<ApiResponse<List<DiscountPolicyV1ApiResponse>>> updateDiscountPolicyUsageStatus(
    ...
    public ResponseEntity<ApiResponse<List<DiscountPolicyV1ApiResponse>>> createDiscountsFromExcelUpload(
    ...
    public ResponseEntity<ApiResponse<PageApiResponse<? extends DiscountTargetV1ApiResponse>>> getDiscountTargets(
            @PathVariable("discountPolicyId") long discountPolicyId, @RequestParam String issueType) {
    ...
    public ResponseEntity<ApiResponse<PageApiResponse<DiscountPolicyV1ApiResponse>>> getDiscountHistories(
    ...
    public ResponseEntity<ApiResponse<PageApiResponse<DiscountUseHistoryV1ApiResponse>>> getDiscountUseHistories(
            @PathVariable("discountPolicyId") long discountPolicyId,
