...
public record OrderV1ApiResponse(
    ...
    public record PaymentDetailV1ApiResponse(
            ...
            @Schema(description = "취소 일시", example = "2024-01-01 00:00:00")
                    @com.fasterxml.jackson.annotation.JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
                    java.time.LocalDateTime canceledDate,
            ...
            @Schema(description = "사용한 마일리지 금액", example = "1000")
                    java.math.BigDecimal usedMileageAmount) {}
    ...
    public record PaymentShipmentInfoV1ApiResponse(
            ...
            @Schema(description = "배송 완료 일시", example = "2024-01-01 00:00:00")
                    @com.fasterxml.jackson.annotation.JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
                    java.time.LocalDateTime shipmentCompletedDate) {}
    ...
    public record SettlementInfoV1ApiResponse(
            ...
            @Schema(description = "예상 정산 금액", example = "85500")
                    java.math.BigDecimal expectationSettlementAmount,
            ...
            @Schema(description = "예상 정산일", example = "2024-01-15 00:00:00")
                    @com.fasterxml.jackson.annotation.JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
                    java.time.LocalDateTime expectedSettlementDay,
            @Schema(description = "정산일", example = "2024-01-15 00:00:00")
                    @com.fasterxml.jackson.annotation.JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
                    java.time.LocalDateTime settlementDay) {}

    @Schema(description = "주문 상품 정보")
    public record OrderProductV1ApiResponse(
            @Schema(description = "주문 ID", example = "1") Long orderId,
            @Schema(description = "상품 그룹 스냅샷 상세")
                    ProductGroupSnapShotDetailsV1ApiResponse productGroupDetails,
            ...
            @Schema(description = "총 예상 환불 마일리지 금액", example = "1000")
                    java.math.BigDecimal totalExpectedRefundMileageAmount,
