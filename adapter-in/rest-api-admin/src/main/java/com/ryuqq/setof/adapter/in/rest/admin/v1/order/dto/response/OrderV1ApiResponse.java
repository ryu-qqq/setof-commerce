...
/**
 * OrderV1ApiResponse - 주문 목록 응답 DTO.
 *
 * <p>레거시 OrderListResponse 기반 변환.
 *
 * @author ryu-qqq
 * @since 1.0.0
 */
...
public record OrderV1ApiResponse(
        ...
        @Schema(description = "주문 이력 목록") List<OrderHistoryV1ApiResponse> orderHistories) {
    ...
    public record SettlementInfoResponse(
            ...
            @Schema(description = "정산 예정일", example = "2025-01-25 00:00:00")
                    LocalDateTime expectedSettlementDate,
            @Schema(description = "할인 셀러 부담 비율", example = "50.0")
                    BigDecimal directDiscountSellerBurdenRatio,
            @Schema(description = "정산 완료일", example = "2025-01-25 10:00:00")
