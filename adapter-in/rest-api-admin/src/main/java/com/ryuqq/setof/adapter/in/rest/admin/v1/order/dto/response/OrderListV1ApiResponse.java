...
public record OrderListV1ApiResponse(@Schema(description = "주문 ID", example = "1") Long orderId,
        ...
        @Schema(description = "배송 정보") OrderV1ApiResponse.PaymentShipmentInfoV1ApiResponse paymentShipmentInfo,
        @Schema(description = "정산 정보") OrderV1ApiResponse.SettlementInfoV1ApiResponse settlementInfo,
