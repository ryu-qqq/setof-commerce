package com.ryuqq.setof.adapter.in.rest.admin.v2.productnotice.error;

import com.ryuqq.setof.adapter.in.rest.admin.common.mapper.ErrorMapper;
import com.ryuqq.setof.domain.common.exception.DomainException;
import com.ryuqq.setof.domain.productnotice.exception.ProductNoticeException;
import java.net.URI;
...
/**
 * ProductNoticeErrorMapper - 상품 고시정보 도메인 예외를 HTTP 응답으로 변환.
 *
...
public class ProductNoticeErrorMapper implements ErrorMapper {
    ...
    public boolean supports(DomainException ex) {
        return ex instanceof ProductNoticeException;
    }
