...
/**
 * RegisterProductGroupDescriptionApiRequest - 상품 그룹 상세 설명 등록 API Request.
 *
 ...
 * @since 1.0.0
 */
@Schema(description = "상품 그룹 상세 설명 등록 요청")
public record RegisterProductGroupDescriptionApiRequest(
        @Schema(
