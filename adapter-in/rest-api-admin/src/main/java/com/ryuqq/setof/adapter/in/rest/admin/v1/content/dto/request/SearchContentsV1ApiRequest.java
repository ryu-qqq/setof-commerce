...
/**
 * SearchContentsV1ApiRequest - 콘텐츠 목록 검색 요청 DTO.
 *
 * <p>레거시 ContentFilter 기반 변환.
 *
 ...
 * @author ryu-qqq
 * @since 1.1.0
 * @see com.connectly.partnerAdmin.module.display.filter.ContentFilter
 */
@Schema(description = "콘텐츠 목록 검색 요청")
public record SearchContentsV1ApiRequest(
        @Parameter(
                        description = "전시 여부",
                        example = "Y",
                        schema = @Schema(allowableValues = {"Y", "N"}))
                String displayYn,
        @Parameter(description = "No-Offset 페이징용 마지막 콘텐츠 ID", example = "12345") Long lastDomainId,
        @Parameter(
                        description = "기간 검색 타입 (필수)",
                        example = "DISPLAY",
                        schema = @Schema(allowableValues = {"DISPLAY", "INSERT"}))
        ...
        @Parameter(description = "검색어", example = "메인 콘텐츠") String searchWord,
