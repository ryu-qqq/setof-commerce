...
public record AddressBookV1ApiResponse(
        ...
        @Schema(description = "배송지 상세 정보", example = "직장")
                ShippingDetailsV1Response shippingDetails,
        @Schema(description = "기본 배송지 여부 (Y/N)", example = "Y") String defaultYn) {

    public record ShippingDetailsV1Response(
            ...
            @Schema(description = "배송 요청 정보", example = "문 앞에 놔주세요") String deliveryRequest,
