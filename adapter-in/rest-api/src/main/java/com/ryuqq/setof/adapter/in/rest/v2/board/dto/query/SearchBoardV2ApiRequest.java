package com.ryuqq.setof.adapter.in.rest.v2.board.dto.query;
...
public record SearchBoardV2ApiRequest(
        @Schema(description = "게시판 타입 (NOTICE, EVENT, NEWS)", example = "NOTICE") String boardType,
