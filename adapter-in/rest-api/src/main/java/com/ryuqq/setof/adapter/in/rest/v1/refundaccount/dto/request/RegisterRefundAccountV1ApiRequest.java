...
/**
 * RegisterRefundAccountV1ApiRequest - 환불 계좌 등록 요청 DTO.
 *
 * <p>레거시 CreateRefundAccount 기반 변환.
 *
 ...
 * @since 1.1.0
 */
@Schema(description = "환불 계좌 등록 요청")
public record RegisterRefundAccountV1ApiRequest(
        @Schema(description = "은행명", example = "국민은행") @NotBlank(message = "은행명은 필수입니다")
                String bankName,
        @Schema(description = "계좌번호 (숫자만)", example = "123456789012")
