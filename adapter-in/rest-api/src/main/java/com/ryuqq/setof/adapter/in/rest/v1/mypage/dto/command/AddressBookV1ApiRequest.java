...
public record AddressBookV1ApiRequest(
        ...
        @Schema(
                ...
                @Size(max = 100, message = "상세 주소는 100자 이내입니다.")
                String addressLine1,
        @Schema(description = "상세 주소 2", example = "124-1234")
                @Size(max = 100, message = "상세 주소는 100자 이내입니다.")
                String addressLine2,
        @Schema(
                        description = "우편번호",
