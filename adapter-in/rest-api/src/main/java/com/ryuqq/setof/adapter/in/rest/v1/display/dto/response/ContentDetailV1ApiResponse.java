...
public record ContentDetailV1ApiResponse(
        ...
        @Schema(description = "컨텐츠 하위 컴포넌트 리스트")
    ...
    public record ComponentDetailV1ApiResponse(
            ...
            @Schema(description = "더보기 페이지 상세 정보")
                    ViewExtensionDetailV1ApiResponse viewExtensionDetails) {}
    ...
    public record ViewExtensionDetailV1ApiResponse(
            ...
            @Schema(description = "버튼 클릭 후 링크 Url", example = "/products/group/12345")
