...
public record ProductV1ApiResponse(
        ...
        @Schema(description = "옵션", example = "빨강 M") @JsonInclude(JsonInclude.Include.NON_DEFAULT)
                String option,
        @Schema(description = "옵션 목록") @JsonInclude(JsonInclude.Include.NON_EMPTY)
                Set<OptionV1ApiResponse> options) {
