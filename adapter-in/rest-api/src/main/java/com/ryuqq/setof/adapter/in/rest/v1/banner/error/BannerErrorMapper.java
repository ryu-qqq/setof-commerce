package com.ryuqq.setof.adapter.in.rest.v1.banner.error;
...
/**
 * BannerErrorMapper - 배너 도메인 예외를 HTTP 응답으로 변환.
 *
 ...
 */
@Component
public class BannerErrorMapper implements ErrorMapper {

    private static final String ERROR_TYPE_PREFIX = "/errors/banner";
