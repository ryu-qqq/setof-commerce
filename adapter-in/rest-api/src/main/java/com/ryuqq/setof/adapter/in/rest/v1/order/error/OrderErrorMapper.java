package com.ryuqq.setof.adapter.in.rest.v1.order.error;
...
public class OrderErrorMapper implements ErrorMapper {
    ...
    public boolean supports(DomainException ex) {
        String code = ex.code();
        return code != null && code.startsWith("ORD-");
    }
