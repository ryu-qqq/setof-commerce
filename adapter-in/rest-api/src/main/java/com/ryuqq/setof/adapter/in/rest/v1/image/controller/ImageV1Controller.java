...
public class ImageV1Controller {
    ...
    @Deprecated
    @Operation(summary = "[Legacy] Image Presigned Url 발급",
            description = "Image upload를 위한 presigned url 발급")
    @PostMapping(ApiPaths.Image.PRESIGNED)
    public ResponseEntity<ApiResponse<PageApiResponse<CreatePreSignedUrlV1ApiResponse>>> getPresignedUrl(
            @RequestBody @Validated CreatePreSignedUrlV1ApiRequest request) {
