...
/**
 * AvailableReviewSliceV1ApiResponse - 작성 가능한 리뷰 커서 기반 페이징 응답 DTO.
 *
 ...
 * @since 1.1.0
 */
@Schema(description = "작성 가능한 리뷰 주문 커서 기반 페이징 응답")
public record AvailableReviewSliceV1ApiResponse(
        @Schema(description = "작성 가능한 리뷰 주문 목록") List<AvailableReviewOrderV1ApiResponse> content,
