...
public record MyPageV1ApiResponse(@Schema(description = "이름", example = "홍길동") String name,
        ...
        @Schema(description = "가입일시", example = "2024-01-01 00:00:00") @JsonFormat(
                pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime registrationDate,
        ...
        @Schema(description = "주문 상태별 개수") List<OrderCountV1ApiResponse> orderCounts) {
