package com.ryuqq.setof.adapter.in.rest.v1.order.dto.query;
...
/**
 * V1 주문 목록 조회 필터 Query
 *
 * @author development-team
 * @since 1.0.0
 */
@Schema(description = "주문 목록 조회 필터")
public record OrderFilterV1ApiRequest(
        @Schema(description = "마지막 조회한 도메인 ID (커서 기반 페이징)", example = "100") Long lastDomainId,
        @Schema(description = "주문 상태 목록",
                example = "[\"COMPLETED\", \"SHIPPING\"]") List<String> orderStatusList,
