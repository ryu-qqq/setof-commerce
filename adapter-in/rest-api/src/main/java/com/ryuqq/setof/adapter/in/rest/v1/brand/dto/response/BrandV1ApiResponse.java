...
public record BrandV1ApiResponse(@Schema(description = "브랜드 ID", example = "100") Long brandId,
        ...
        @Schema(description = "로고 이미지 URL",
                example = "https://cdn.example.com/logo/brandA.png") String brandIconImageUrl) {
}
