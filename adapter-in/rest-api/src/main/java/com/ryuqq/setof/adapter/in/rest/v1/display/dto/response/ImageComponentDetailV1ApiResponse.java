 ...
 *
 * <p>
 * 이미지 컴포넌트의 상세 정보를 반환하는 응답 DTO입니다.
 *
...
public record ImageComponentDetailV1ApiResponse(
        ...
        @Schema(description = "이미지 컴포넌트 링크 목록") List<ImageComponentLinkV1ApiResponse> imageComponentLinks)
        implements SubComponentV1ApiResponse {

    @Schema(description = "이미지 컴포넌트 링크 응답")
    public record ImageComponentLinkV1ApiResponse(
            @Schema(description = "이미지 URL",
                    example = "https://cdn.example.com/image.jpg") String imageUrl,
