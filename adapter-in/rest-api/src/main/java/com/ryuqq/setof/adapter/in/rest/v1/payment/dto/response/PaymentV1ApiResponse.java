...
public record PaymentV1ApiResponse(
        ...
        @Schema(description = "환불 계좌 정보") @JsonInclude(JsonInclude.Include.NON_NULL)
    ...
    public record PaymentDetailV1ApiResponse(
            ...
            @Schema(description = "총 예상 마일리지 금액", example = "900.0")
    ...
    public record VBankAccountV1ApiResponse(
            ...
            @Schema(description = "계좌번호", example = "110123456789") String accountNumber,
            @Schema(description = "결제 금액", example = "90000") Long paymentAmount,
            @Schema(description = "가상계좌 입금 기한", example = "2024-01-31 23:59:59")
                    @com.fasterxml.jackson.annotation.JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
                    java.time.LocalDateTime vBankDueDate) {}
    ...
    public record OrderProductV1ApiResponse(
            ...
            @Schema(description = "총 예상 환불 마일리지 금액", example = "1000.0")
                    Double totalExpectedRefundMileageAmount,
