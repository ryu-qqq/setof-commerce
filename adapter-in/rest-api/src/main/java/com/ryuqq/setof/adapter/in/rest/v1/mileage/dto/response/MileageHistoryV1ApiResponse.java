 ...
 *
 * <p>날짜 포맷은 Mapper에서 DateTimeFormatUtils.format()으로 "yyyy-MM-dd HH:mm:ss" 문자열 변환.
 *
 ...
 * @param usedDate 사용/적립 일시 (yyyy-MM-dd HH:mm:ss)
 * @param expirationDate 만료일 (yyyy-MM-dd HH:mm:ss)
 * @author ryu-qqq
 * @since 1.0.0
...
public record MileageHistoryV1ApiResponse(
        ...
        @Schema(description = "결제 ID (주문 관련 마일리지인 경우)", example = "0") long paymentId,
        @Schema(description = "주문 ID (주문 관련 마일리지인 경우)", example = "0") long orderId,
        ...
        @Schema(
                ...
                String reason,
        @Schema(description = "사용/적립 일시", example = "2026-01-15 10:30:00") String usedDate,
        @Schema(description = "만료일", example = "2027-01-15 23:59:59", nullable = true)
