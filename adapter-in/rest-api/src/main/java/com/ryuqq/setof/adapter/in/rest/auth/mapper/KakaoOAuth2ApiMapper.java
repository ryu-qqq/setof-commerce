 ...
 */
@Component
public class KakaoOAuth2ApiMapper {
     ...
     * @param integration 기존 회원 통합 요청 여부
     * @return KakaoOAuthCommand
     */
    public KakaoOAuthCommand toKakaoOAuthCommand(OAuth2User oAuth2User, boolean integration) {
        Map<String, Object> attributes = oAuth2User.getAttributes();
        Map<String, Object> kakaoAccount = getKakaoAccount(attributes);

        return KakaoOAuthCommand.withIntegration(
